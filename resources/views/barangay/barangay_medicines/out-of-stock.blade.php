...
@section('content')
    ...
    <style>
        ...
        body.dark-mode #generateBarangayOutOfStockReportModal .modal-content {
            background-color: #343a40;
            color: #fff;
        }

        body.dark-mode #generateBarangayOutOfStockReportModal .modal-header {
            background-color: #343a40;
            color: #fff;
            border-bottom: 1px solid #007bff;
        }

        body.dark-mode #generateBarangayOutOfStockReportModal .modal-title {
            color: #fff;
        }

        body.dark-mode #generateBarangayOutOfStockReportModal .modal-body {
            background-color: #343a40;
            color: #fff;
        }

        body.dark-mode #generateBarangayOutOfStockReportModal label,
        body.dark-mode #generateBarangayOutOfStockReportModal .form-control {
            color: #fff;
        }
        ...
        body.dark-mode #generateBarangayOutOfStockReportModal .modal-footer {
            background-color: #343a40;
            border-top: 1px solid #007bff;
        }

        body.dark-mode #generateBarangayOutOfStockReportModal .btn-secondary {
            color: #fff;
        }
    </style>
@endsection
