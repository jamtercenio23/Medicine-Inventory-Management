    ...
    <div class="container-fluid">
        ...
        <div class="my-4 text-muted">
            ...
            <div class="float-right">
                ...
                <ul class="pagination">
                    <li class="page-item {{ $barangayPatients->onFirstPage() ? 'disabled' : '' }}">
                    ...
                    @if ($showFirstDots)
                        <li class="page-item">
                            <a class="page-link" href="{{ $barangayPatients->url(1) }}">1</a>
                        </li>
                    ...
                    @if ($showLastDots)
                        ...
                        <li class="page-item">
                            <a class="page-link" href="{{ $barangayPatients->url($lastPage) }}">{{ $lastPage }}</a>
                        </li>
                    @endif
