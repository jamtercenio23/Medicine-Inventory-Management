...
@section('content')
            ...
            <div class="float-right">
                ...
                <ul class="pagination">
                    <li class="page-item {{ $distributions->currentPage() == 1 ? 'disabled' : '' }}">
                        <a class="page-link" href="{{ $distributions->previousPageUrl() }}&entries={{ $entries }}"
                            aria-label="Previous">
                    ...
                    @if ($showFirstDots)
                        <li class="page-item">
                            <a class="page-link" href="{{ $distributions->url(1) }}&entries={{ $entries }}">1</a>
                        </li>
                    ...
                    @for ($i = $startPage; $i <= $endPage; $i++)
                        <li class="page-item {{ $i == $currentPage ? 'active' : '' }}">
                            <a class="page-link"
                                href="{{ $distributions->url($i) }}&entries={{ $entries }}">{{ $i }}</a>
                        </li>
                    @endfor
                    ...
                    @if ($showLastDots)
                        ...
                        <li class="page-item">
                            <a class="page-link"
                                href="{{ $distributions->url($lastPage) }}&entries={{ $entries }}">{{ $lastPage }}</a>
                        </li>
                    @endif

                    <li class="page-item {{ $distributions->currentPage() == $lastPage ? 'disabled' : '' }}">
                        <a class="page-link" href="{{ $distributions->nextPageUrl() }}&entries={{ $entries }}"
                            aria-label="Next">
    ...
    <script>
        ...
        function handleSort(column) {
            ...
            window.location = "{{ route('distributions.index') }}?column=" + column + "&order=" + order + "&entries=" +
                entries;
        }
    </script>
    <style>
